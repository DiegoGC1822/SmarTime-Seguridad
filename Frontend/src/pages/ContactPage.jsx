      ...
      <main className="cuadros-container">
        <section className="bg-white rounded-lg shadow-md p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="cuadro aprende-mas">
            ...
            <div className="flex items-center mb-2">SmartWork</div>
            <div className="flex items-center mb-2">Trabajo</div>
            <div className="flex items-center">Contáctanos</div>
          </div>

          {/* Contáctanos */}
          <div className="cuadro">
            <h2 className="text-lg font-bold mb-4">Contáctanos</h2>
            <div className="flex items-center mb-2">Teléfono: 999999999</div>
