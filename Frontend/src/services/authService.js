...
export const requestPasswordReset = async (email) => {
  ...
  try {
    const response = await apiClient.post(
      `${AUTH_BASE_PATH}/solicitarNuevaContrasena/`,
      { email }
    );
    console.log(
      "authService: Solicitud de restablecimiento enviada:",
      response.data
    );
    return response.data;
  } catch (error) {
    ...
    console.error(
      "Error en requestPasswordReset service:",
      errorMessage,
      error.response
    );
    throw new Error(errorMessage);
...
export const logoutUser = async () => {
  ...
  try {
    ...
    const errorMessage = getErrorMessage(
      error,
      "Error durante el logout en el servidor, pero la sesión local ha sido limpiada."
    );
    console.warn(
      "Error en logoutUser service (backend call):",
      errorMessage,
      error.response
    );
    return null;
...
export const resetPasswordWithToken = async (
  ...
  try {
    ...
    const response = await apiClient.post(
      `${AUTH_BASE_PATH}/generarNuevaContrasena/`,
      payload
    );
    return response.data;
  } catch (error) {
    ...
    console.error(
      "Error en resetPasswordWithToken service:",
      errorMessage,
      error.response
    );
    throw new Error(errorMessage);
