...
const TaskForm = ({ onClose, onSave, type, initialData, ErrorMessage }) => {
  ...
  return (
    <div className="modal-overlay">
      <form
        className={`task-form ${getTypeClass(type)}`}
          ...
          {type === "Tarea" && (
            <>
              ...
              <div className="form-row">
                ...
                <textarea
                  name="description"
                  placeholder="Añade una descripción breve de la tarea"
              ...
              <div className="form-row">
                ...
                <input
                  ...
                  value={taskData.realizationDate}
                  onChange={handleChange}
                />
              </div>
              <div className="form-row">
